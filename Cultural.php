...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Cultural Photography & Cinematography</title>
        <!-- Meta -->
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <h2>Cultural Photography & Cinematography</h2>
...
?>
                            ...
                            <div class="row">
                              <div class="col-sm-8">
                                <?php
                                    global $ConnectingDB;
                                    $ViewQuery="SELECT * FROM admin_panel WHERE category='Cultural photography & Cinematography' ORDER BY datetime desc";
                                    $Execute=mysqli_query($connection,$ViewQuery);
                                while ($DataRows=mysqli_fetch_array($Execute)) {
                                  $PostId=$DataRows["id"];
                                  $DateTimes=$DataRows["datetime"];
                                ...
                                <h1 id="heading"><?php echo htmlentities($Title) ?></h1>
                                   ...
                                   <div class="caption">
                                     <p style="text-align:left;" class="description"><b>Category:</b> <?php echo htmlentities($Category) ?>.
                                      <br>  <b>Published on:</b><?php echo htmlentities($DateTimes) ?>
                                     </p>
                                      <a href="FullPost.php?id=<?php echo $PostId ?>"
                                        <span class="btn btn-info" id="btn-info"> View Photo &rsaquo;&rsaquo;
                                        </span>
                                      </a>
                                   </div>
