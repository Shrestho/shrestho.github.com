...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Corporate photography & Cinematography</title>
        <!-- Meta -->
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <h2>Corporate photography & Cinematography</h2>
...
?>
                            ...
                            <div class="row">
                              <div class="col-sm-8">
                                <?php
                                    global $ConnectingDB;
                                    $ViewQuery="SELECT * FROM admin_panel WHERE Category='Corporate photography & Cinematography' ORDER BY datetime desc";
                                    $Execute=mysqli_query($connection,$ViewQuery);
                                while ($DataRows=mysqli_fetch_array($Execute)) {
                                  $PostId=$DataRows["id"];
                                  $DateTimes=$DataRows["datetime"];
