...
if(isset($_POST["Submit"])){
  ...
  if(empty($title)){
    $_SESSION["ErrorMessaage"]= "Title can not be empty";
    Redirect_to("addnewpost.php");
  }elseif (strlen($title)<2){
    $_SESSION["ErrorMessaage"]= " Title too short";
    Redirect_to("addnewpost.php");
  } else {
    global $ConnectingDB;
    $Query="INSERT INTO admin_panel(datetime,title,category,image,status)
    VALUES('$DateTime','$title','$Category','$Image','ON')";
    $Execute=mysqli_query($connection,$Query);
    move_uploaded_file($_FILES["Image"]["tmp_name"],$Target);
    if ($Execute) {
      $_SESSION["SuccessMessaage"]="New Post Added";
      Redirect_to("mainaddnewpost.php");
    }else {
...
<div class="row">
  <div class="col-sm-2">
    ...
    <ul id="Side_Menu" class="nav nav-pills nav-stacked">
      ...
      <li class="active"> <a href="mainaddnewpost.php"><span class="glyphicon glyphicon-list-alt"> </span>&nbsp;  Add New post</a> </li>
  ...
  <div class="col-sm-10">
    ...
    <h1>Add new post:</h1>
<form class="" action="mainaddnewpost.php" method="post" enctype="multipart/form-data">
  <fieldset>
