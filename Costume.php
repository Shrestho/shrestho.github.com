...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Costume Designing & Management</title>
        <!-- Meta -->
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <h2>Costume Designing & Management</h2>
...
?>
                            ...
                            <div class="row">
                              <div class="col-sm-8">
                                <?php
                                    global $ConnectingDB;
                                    $ViewQuery="SELECT * FROM admin_panel WHERE category='Costume designing & management' ORDER BY datetime desc";
                                    $Execute=mysqli_query($connection,$ViewQuery);
                                while ($DataRows=mysqli_fetch_array($Execute)) {
                                  $PostId=$DataRows["id"];
                                  $DateTimes=$DataRows["datetime"];
