...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Cartoon Making & Portrate Making</title>
        <!-- Meta -->
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <h2>Cartoon Making & Portrate Making</h2>
...
?>
                            ...
                            <div class="row">
                              <div class="col-sm-8">
                                <?php
                                    global $ConnectingDB;
                                    $ViewQuery="SELECT * FROM admin_panel WHERE category='Cartoon making & portrait making' ORDER BY datetime desc";
                                    $Execute=mysqli_query($connection,$ViewQuery);
                                while ($DataRows=mysqli_fetch_array($Execute)) {
                                  $PostId=$DataRows["id"];
                                  $DateTimes=$DataRows["datetime"];
                                ...
                                <h1 id="heading"><?php echo htmlentities($Title) ?></h1>
                                   ...
                                   <div class="caption">
                                     <p style="text-align:left;" class="description"><b>
